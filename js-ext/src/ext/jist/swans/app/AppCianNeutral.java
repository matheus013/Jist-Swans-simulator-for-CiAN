...
public class AppCianNeutral extends AppWorkflowBase implements AppInterface {
...
////        }
    ...
    private void scheduleTimeoutFor(String wfId, Long at) {
        try {
            timeUp = false;
            Method m = ext.jist.swans.app.AppCianNeutral.class.getMethod("timeoutProxyMethod", new Class[] {
                    java.lang.String.class, ext.jist.swans.app.AppCianNeutral.class });
