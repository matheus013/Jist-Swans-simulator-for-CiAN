...
public class AppCianHost3 extends AppWorkflowBase implements AppInterface {
...
////        }
    ...
    private void scheduleTimeoutFor(String wfId, Long at) {
        try {
            timeUp = false;
            Method m = ext.jist.swans.app.AppCianHost3.class.getMethod("timeoutProxyMethod", new Class[] {
                    java.lang.String.class, ext.jist.swans.app.AppCianHost3.class });
    ...
    public static void timeoutProxyMethod(String wfId, AppCianHost3 provider) {
