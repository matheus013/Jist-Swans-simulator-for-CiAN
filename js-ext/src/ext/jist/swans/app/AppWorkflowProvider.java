...
public class AppWorkflowProvider extends AppWorkflowBase implements
	...
	public AppWorkflowProvider(int nodeId, DucksCompositionStats stats,
			String mode, HashMap<Character, Integer> repository,
			String compoRestrict) {
		super(nodeId, stats);
	...
	private void scheduleTimeoutFor(String wfId, Long at) {
		try {
			timeUp = false;
			Method m = ext.jist.swans.app.AppWorkflowProvider.class.getMethod(
					"timeoutProxyMethod", new Class[] { java.lang.String.class,
							ext.jist.swans.app.AppWorkflowProvider.class });
