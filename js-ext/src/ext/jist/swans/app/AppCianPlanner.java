...
public class AppCianPlanner extends AppWorkflowBase implements AppInterface {
    ...
    public AppCianPlanner(int nodeId, DucksCompositionStats stats, int reqSize, int reqRate, int waitTimeStart,
    ...
    public static void timeoutProxyMethod(String wfId, AppCianPlanner provider) {
        provider.timeout(wfId);
    }

    private void scheduleTimeoutFor(String wfId, Long at) {
        try {
            Method m = ext.jist.swans.app.AppCianPlanner.class.getMethod("timeoutProxyMethod", new Class[] {
                    java.lang.String.class, ext.jist.swans.app.AppCianPlanner.class });
