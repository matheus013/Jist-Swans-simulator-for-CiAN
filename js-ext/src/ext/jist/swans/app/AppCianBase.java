...
public abstract class AppCianBase implements AppInterface,
	...
	// protected abstract void handleWorkflowRequest(WorkflowRequest req,
	// NetAddress src);
...
// private String id;
// private int version; // currently not used, but later when wf is transformed
...
// this.id = (new Integer(nodeId)).toString()+"-"+(new
// Integer(msgId)).toString();
...
// }
//
// public Workflow(String id, int version, char[] services, int[] inputs, int
// nextIndexToExecute, long arrival){
...
// private int nextIndexToExecute;
//
// public WorkflowRequest(String id, int version, char[] services, int[] inputs,
// int nextIndexToExecute){
// super(id);
// this.version = version;
// this.services = services;
// this.inputs = inputs;
...
// public int getSize() {
// return
// Sizeof.inst(id.toCharArray())+Sizeof.inst(version)+Sizeof.inst(services)+Sizeof.inst(inputs)+Sizeof.inst(nextIndexToExecute);
// }
// }
//
...
//
// public ServiceAd(String id, int advertiser, char service, double
// connectivity){
// super(id);
...
// public int getSize() {
// return
// Sizeof.inst(id.toCharArray())+Sizeof.inst(advertiser)+Sizeof.inst(service)+Sizeof.inst(connectivity);
// }
// }
//
...
// public int getSize() {
// return
// Sizeof.inst(id.toCharArray())+Sizeof.inst(service)+Sizeof.inst(input)+Sizeof.inst(provider);
// }
// }
//
//
