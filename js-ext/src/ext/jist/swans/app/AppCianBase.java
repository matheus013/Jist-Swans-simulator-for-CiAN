...
public abstract class AppCianBase extends AppCompositionBase{ 
    /**
...
//
//    public int getSize() {
//        return Sizeof.inst(id.toCharArray())+Sizeof.inst(version)+Sizeof.inst(services)+Sizeof.inst(inputs)+Sizeof.inst(nextIndexToExecute);
//    }
//}
//
...
//    @Override
//    public int getSize() {
//        return Sizeof.inst(id.toCharArray())+Sizeof.inst(advertiser)+Sizeof.inst(service)+Sizeof.inst(connectivity);
//    }
//}
//
