...
public class AppCianHost2 extends AppWorkflowBase implements AppInterface {
    ...
    public AppCianHost2(int nodeId, DucksCompositionStats stats, String mode,
...
////        }
    ...
    private void scheduleTimeoutFor(String wfId, Long at) {
        try {
            timeUp = false;
            Method m = ext.jist.swans.app.AppCianHost2.class.getMethod("timeoutProxyMethod", new Class[] {
                    java.lang.String.class, ext.jist.swans.app.AppCianHost2.class });
    ...
    public static void timeoutProxyMethod(String wfId, AppCianHost2 provider) {
