...
public class aodvsim
{
    ...
    public static void addNode(CommandLineOptions opts, int i, Vector routers, RouteAodv.AodvStats stats, Field field,
            Placement place, RadioInfo.RadioInfoShared radioInfo, Mapper protMap, PacketLoss inLoss, PacketLoss outLoss) {
        // radio
    ...
    private static void buildField(CommandLineOptions opts, final Vector routers, final RouteAodv.AodvStats stats) {
        ...
        // initialize field
        Field field = new Field(spatial, new Fading.None(), new PathLoss.FreeSpace(), mobility,
        ...
        long delayInterval = (long) StrictMath.ceil((double) opts.duration * (double) Constants.SECOND
                / (double) numTotalMessages);
