...
public class DucksRadioNoiseAdditiveStats implements StatsCollector {
	...
	public ExtendedProperties getStats() {
		...
		stats.put(NOISE_ADD_STAT_LOST_WEAK,
				Integer.toString(appDiscReqLostWeak));
		stats.put(NOISE_ADD_STAT_LOST_COLL,
				Integer.toString(appDiscReqLostColl));
		stats.put(NOISE_ADD_STAT_LOST_TRAN,
				Integer.toString(appDiscReqLostTran));
		stats.put(NOISE_ADD_STAT_LOST_SLEE,
				Integer.toString(appDiscReqLostSlee));
