...
// Timestamp: <Placement.java Tue 2004/04/06 11:31:11 barr
...
public interface Placement
{
    ...
    public static class Random implements Placement
    {
        ...
        public Location getNextLocation() {
            return new Location.Location2D(Constants.random.nextFloat() * x, Constants.random.nextFloat() * y);
        }
    ...
    public static class Grid implements Placement
    {
        ...
        public Location getNextLocation() {
            ...
            Location l = new Location.Location2D((i % nodex) * fieldx / nodex, (i / nodex) * fieldy / nodey);
            i++;
            return l;
        }
