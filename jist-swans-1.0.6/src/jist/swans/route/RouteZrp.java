...
public class RouteZrp implements RouteInterface.Zrp
{
     ...
     *            IERP sub-protocol implementation
     */
    public void setSubProtocols(RouteInterface.Zrp.Ndp ndp, RouteInterface.Zrp.Iarp iarp, RouteInterface.Zrp.Brp brp,
    ...
    public void broadcast(MessageZrp msg) {
        ...
        netEntity.send(msg, NetAddress.ANY, Constants.NET_PROTOCOL_ZRP, Constants.NET_PRIORITY_NORMAL, (byte) 1);
    }
