...
// Timestamp: <RouteInterface.java Tue 2004/04/06 11:35:24 barr
...
public interface RouteInterface extends NetInterface.NetHandler, JistAPI.Proxiable
{
    ...
    public static interface Zrp extends RouteInterface, Protocol
    {
        ...
        public static interface Ndp extends Protocol
        {
             ...
             *            ndp packet
             * @param src
             *            network address of incoming packet
             * @param macAddr
             *            link source address of incoming packet
             * @param macId
             *            interface of incoming packet
             */
        ...
        public static interface Iarp extends Protocol
        {
             ...
             * 
             * @param link
             *            link that has changed
             * @param drop
             *            whether link has failed (or been created)
             */
        ...
        public static interface Ierp extends Protocol
        {
             ...
             * 
             * @param msg
             *            network message to route and send
             */
    ...
    public static interface Dsr extends RouteInterface
    {
         ...
         * 
         * @param dest
         *            the destination to which a route is being sought
         * @param requestId
         *            the ID number of this route discovery
         */
         ...
         * @param timeout
         *            the timeout before retransmitting the packet
         * @param numRetransmits
         *            the number of times <code>msg</code> has already been
         *            retransmitted
         */
        void TransmitWithNetworkAck(NetMessage.Ip msg, Short ackId, long timeout, int numRetransmits);

        /**
         * Transmits the given packet and waits for a passive acknowledgement.
         * If no passive acknowledgement is received before a timeout occurs,
         * the packet is retransmitted. If no acknowledgement is received after
         ...
         * 
         * @param originator
         *            the originator of the packet being replied to
         * @param lastHop
         *            the last-hop address of the packet being replied to
         */
         ...
         * 
         * @param originator
         *            the originator of the packet being removed
         * @param lastHop
         *            the last-hop address of the packet being removed
         */
         ...
         * 
         * @param msg
         *            the packet to insert into the send buffer
         */
         ...
         * 
         * @param packet
         *            the <code>BufferedPacket</code> to be removed from the
         *            send buffer
         */
    ...
    public static interface Cggc extends RouteInterface, Protocol
    {
        ...
        /**
         * Timeout event, which gets called periodically. Primarily responsible
         * for beaconing.
         */
        void timeout();
