...
// Timestamp: <RouteDsrMsg.java Tue 2004/04/06 11:35:14 barr
...
public class RouteDsrMsg implements Message, Cloneable
{
    ...
    public static class OptionSourceRoute extends Option
    {
         ...
         * @return The byte array corresponding to the desired option.
         */
        public static byte[] create(boolean firstHopExternal, boolean lastHopExternal, int salvage, int segsLeft,
                NetAddress[] addrs) {
