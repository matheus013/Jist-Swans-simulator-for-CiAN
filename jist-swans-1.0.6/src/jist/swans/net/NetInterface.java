...
public interface NetInterface extends JistAPI.Proxiable {
	 ...
	 */
	void receive(Message msg, MacAddress lastHop, byte macId,
			boolean promiscuos, boolean bcast);
	 ...
	 */
	void send(Message msg, NetAddress dst, short protocol, byte priority,
			byte ttl);
