...
// Timestamp: <MessageQueue.java Tue 2004/04/06 11:32:34 barr
...
/**
 * Implements a prioritized queue of items. Items are dequeued in order of their
 * priority, where a lower value priority comes first in the queue. Priority
 * values should be in the range [0, priorities), where <code>priorities</code>
...
public interface MessageQueue
{
     ...
     * @return message of given priority (not dequeued), or null if no such
     *         message exists
     */
    ...
    public class NoDropMessageQueue implements MessageQueue
    {
         ...
         * @param capacity
         *            maximum number of items allowed in list
         */
