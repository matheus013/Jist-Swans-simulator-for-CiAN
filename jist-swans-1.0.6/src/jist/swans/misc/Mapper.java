 ...
 * numbers consistently, but in a smaller index range, in order to reduce array
 * sizes.
 * 
...
public final class Mapper
{
     ...
     * 
     * @param max
     *            map indices should be non-negative and less than max.
     */
