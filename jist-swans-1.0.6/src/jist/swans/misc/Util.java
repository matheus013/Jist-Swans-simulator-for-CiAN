...
public final class Util {
	...
	public static String timeSeconds() {
		return (jist.runtime.JistAPI.getTime() / (float) Constants.SECOND)
				+ " sec";
	}
	...
	public static Object rest(Object values) {
		...
		Object[] result = (Object[]) Array.newInstance(values.getClass()
				.getComponentType(), Array.getLength(values) - 1);
