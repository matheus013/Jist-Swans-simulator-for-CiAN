...
// Timestamp: <RadioNoise.java Tue 2004/04/13 18:22:55 barr
 ...
 * functionality that is common to the independent and additive radio noise
 * simulation models.
 * 
...
public abstract class RadioNoise implements RadioInterface
{
     ...
     * 
     * @param msg
     *            packet currently on the air
     * @param power_mW
     *            signal power (units: mW)
     * @param duration
     *            time to EOT (units: simtime)
     */
