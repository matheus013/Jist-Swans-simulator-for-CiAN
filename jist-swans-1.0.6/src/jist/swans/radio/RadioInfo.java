...
// Timestamp: <RadioInfo.java Tue 2004/04/06 11:31:32 barr
...
public class RadioInfo implements JistAPI.Timeless
{
     ...
     */
    public static RadioInfoShared createShared(double frequency, int bandwidth, double transmit, double gain,
            double sensitivity_mW, double threshold_mW, double temperature, double thermalFactor, double ambientNoise_mW) {
        return createShared(frequency, bandwidth, transmit, gain, sensitivity_mW, threshold_mW, temperature,
                thermalFactor, ambientNoise_mW, true // to emulate the old
                                                     // behavior set true by
                                                     // default
        );
    }
     ...
     */
    public static RadioInfoShared createShared(double frequency, int bandwidth, double transmit, double gain,
            double sensitivity_mW, double threshold_mW, double temperature, double thermalFactor,
