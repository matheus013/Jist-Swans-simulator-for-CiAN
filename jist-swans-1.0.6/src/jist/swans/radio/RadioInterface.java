...
// Timestamp: <RadioInterface.java Tue 2004/04/13 18:22:52 barr
...
public interface RadioInterface extends JistAPI.Proxiable
{
    ...
    /**
     * Start transmitting message. Puts radio into transmission mode and
     * contacts other radios that receive the signal. Called from mac entity.
     * 
     * @param msg
    ...
    /**
     * Start receiving message. Puts radio into receive or sensing mode
     * depending on the message power and the state of the radio. A radio that
     * is currently transmitting will ignore incoming messages. Called from
     * field entity.
     * 
     * @param msg
     *            incoming message
     ...
     * @param duration
     *            time until end of transmission (units: simtime)
     */
     ...
     * sends the received message to upper layers for processing, if no error
     * has occurred during the reception. Called from field entity.
     * 
     * @param power
     *            signal strength of incoming message (units: mW)
     */
