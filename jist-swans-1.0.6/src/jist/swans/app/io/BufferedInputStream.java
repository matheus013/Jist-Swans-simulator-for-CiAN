...
// Timestamp: <BufferedInputStream.java Tue 2004/04/06 11:44:40 barr
...
public class BufferedInputStream extends FilterInputStream
{
    ...
    /** @see java.io.BufferedInputStream */
    public synchronized int read(byte[] b, int off, int len) throws IOException, JistAPI.Continuation {
        ensureOpen();
