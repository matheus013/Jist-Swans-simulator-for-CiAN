 ...
 * @since SWANS1.0
 */
public class AppJava implements AppInterface, AppInterface.TcpApp,
		AppInterface.UdpApp, AppInterface.ThreadedApp {
	 ...
	 *             unable to find main method in application class
	 */
	 ...
	 *             unable to find main method in application class
	 */
	public AppJava(String app) throws ClassNotFoundException,
	 ...
	 * @throws NoSuchMethodException
	 *             if class does not contain a main method
	 */
	...
	public TransInterface.TransUdpInterface getUdpEntity() {
		if (udp == null)
			throw new NullPointerException(
					"UDP entity has not been set in AppJava application context.");
		return udp;
	}
	...
	public TransInterface.TransTcpInterface getTcpEntity() {
		if (tcp == null)
			throw new NullPointerException(
					"TCP entity has not been set in AppJava application context.");
		return tcp;
	}

	/** {@inheritDoc} */
	public void setCurrentThread(SimtimeThread thread) {
		if (!JistAPI.isEntity(thread))
			throw new IllegalArgumentException("expected entity");
		this.thread = thread;
	}
	...
	public SimtimeThread getCurrentThread() {
		if (thread == null)
			throw new NullPointerException(
					"current thread has not been set in AppJava application context.");
		return thread;
	}
