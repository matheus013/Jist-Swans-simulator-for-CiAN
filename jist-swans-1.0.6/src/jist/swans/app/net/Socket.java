...
public class Socket {
	...
	public Socket(InetAddress address, int port, InetAddress localAddr,
			int localPort) {
		TcpSocket newSocketEntity = new TcpSocket(address, port, localAddr,
				localPort);
		socketEntity = newSocketEntity.getProxy();
	}
	...
	public Socket(String host, int port, InetAddress localAddr, int localPort) {
		TcpSocket newSocketEntity = new TcpSocket(host, port, localAddr,
				localPort);
		socketEntity = newSocketEntity.getProxy();
	}
	...
	public void _jistPostInit() {
		socketEntity.setTcpEntity(((AppInterface.TcpApp) JistAPI.proxy(
				JistAPI.THIS, AppInterface.TcpApp.class)).getTcpEntity());
