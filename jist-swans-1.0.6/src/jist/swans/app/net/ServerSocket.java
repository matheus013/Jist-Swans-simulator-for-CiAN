...
// Timestamp: <ServerSocket.java Tue 2004/04/06 11:45:48 barr
...
public class ServerSocket
{
    ...
    public void _jistPostInit() {
        serverSocketEntity.setTcpEntity(((AppInterface.TcpApp) JistAPI.proxy(JistAPI.THIS, AppInterface.TcpApp.class))
                .getTcpEntity());
