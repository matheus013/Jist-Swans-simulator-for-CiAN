 ...
 * @since SWANS1.0
 */
public interface TransInterface extends JistAPI.Proxiable,
	 ...
	 * 
	 * @param msg
	 *            packet payload (usually from application layer)
	 * @param dst
	 ...
	 *            packet priority
	 */
	void send(Message msg, NetAddress dst, int dstPort, int srcPort,
			byte priority);
	 ...
	 */
	void addSocketHandler(int port, SocketHandler socketCallback)
			throws JistAPI.Continuation;
