...
// Timestamp: <SocketInterface.java Tue 2004/04/06 11:36:47 barr
...
public interface SocketInterface extends JistAPI.Proxiable
{
     ...
     * limitation), we rewrite a regular socket constructor to two calls. This
     * is the second one, and it can be blocking, because it is a regular
     * method.
     * 
    ...
    /**
     * Check and process the incoming packet depending on current state of the
     * socket.
     * 
     * @param msg
    ...
    public interface TcpSocketInterface extends SocketInterface
    {
        ...
        /**
         * Returns the unique SocketChannel object associated with this socket,
         * if any.
         * 
         * @return the socket channel associated with this socket, or null if
         ...
         * 
         * @param on
         *            true to enable OOBINLINE, false to disable.
         */
        ...
        /**
         * This method is called to send bytes to the other side. What this
         * method does is storing the bytes in the send buffer and then call
         * sendPackets method to send the bytes.
         * 
         * @param data
        ...
        /**
         * This method is called by the input stream to retrieve data from the
         * transport layer.
         * 
         * @param length
        ...
        /**
         * Creates packets to be sent based on the receiver's advertised window
         ...
         * 
         * @param seqNum
         *            sequence number of message to retransmit
         * @param time
         *            wait time before attempting to retransmit
         */
        ...
        /**
         * Methods for persist timer (sender sending packets to probe receiver
         * window).
         * 
         * @param seqNum
         *            number of the probe message
         */
        ...
        /**
         * Methods for reset timer (this timer is used when establishing or
         * closing connection --> If no reply is received, connection is reset).
         */
