...
public final class Main
{
    ...
    public static void main(String[] args) {
        try {
            ...
            // show usage
            if (options.help || (options.sim == null && !options.bsh && !options.jpy)) {
                showVersion();
                showUsage();
                return;
            }
            ...
            // and start the show
            if (options.bsh) {
                String bshInit = "import jist.swans.*;" + "import jist.swans.misc.*;" + "import jist.swans.field.*;"
                        + "import jist.swans.radio.*;" + "import jist.swans.mac.*;" + "import jist.swans.net.*;"
                        + "import jist.swans.route.*;" + "import jist.swans.trans.*;" + "import jist.swans.app.*;";
