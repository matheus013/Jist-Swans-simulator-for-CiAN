...
public final class Main {
	...
	private static void showVersion() {
		System.out.println("SWANS v" + VERSION
	...
	private static void showUsage() {
		...
		System.out
				.println("  -c, --conf      use given properties file [swans.properties]");
		System.out
				.println("  -l, --logger    use given logging implementation class");
		...
		System.out
				.println("  sim       is:   SWANS driver program with command-line arguments, or");
		System.out
				.println("                  SWANS driver script with command-line arguments, or");
		System.out
				.println("                   (missing script or -- implies interactive shell)");
		System.out.println();
	}
	...
	public static void main(String[] args) {
		try {
			...
			try {
				...
				System.out.println("Logging config file for SWANS ("
						+ options.properties + ") was not found");
			}
			// set up logging
			if (config != null) {
			...
			if (options.logger != null) {
				try {
					...
					JistAPI.Logger logger = (JistAPI.Logger) loggerClass
							.newInstance();
					JistAPI.setLog(logger);
				} catch (ClassNotFoundException e) {
					System.out.println("Logger class not found: "
							+ e.getMessage());
					return;
				} catch (InstantiationException e) {
					System.out.println("Could not instantiate logger class: "
							+ e.getMessage());
					return;
				} catch (IllegalAccessException e) {
					System.out
							.println("Illegal access exception to logger class: "
									+ e.getMessage());
					return;
				}
			}
			...
			// and start the show
			if (options.bsh) {
				String bshInit = "import jist.swans.*;"
