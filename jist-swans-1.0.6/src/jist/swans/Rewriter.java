        ...
        public void doInstruction(ClassGen cg, MethodGen mg, InstructionHandle ih, Instruction inst) {
            ...
            if (inst instanceof FieldInstruction) {
                ...
                if (!isIgnored(fi.getClassName(cpg))
                        && (shouldTransformName(fi.getClassName(cpg)) || shouldTransformType(fi.getType(cpg)))) {
                    short itype = inst instanceof GETFIELD ? org.apache.bcel.Constants.GETFIELD
                            : inst instanceof PUTFIELD ? org.apache.bcel.Constants.PUTFIELD
                                    : inst instanceof GETSTATIC ? org.apache.bcel.Constants.GETSTATIC
                                            : inst instanceof PUTSTATIC ? org.apache.bcel.Constants.PUTSTATIC : -1;
                    ih.swapInstruction(ifc.createFieldAccess(transformName(fi.getClassName(cpg)), fi.getName(cpg),
            ...
            if (inst instanceof InvokeInstruction) {
                ...
                if (!isIgnored(ii.getClassName(cpg))
                        && (shouldTransformName(ii.getClassName(cpg)) || shouldTransformType(ii.getReturnType(cpg)) || shouldTransformTypes(ii
                            ...
                            : inst instanceof INVOKESPECIAL ? org.apache.bcel.Constants.INVOKESPECIAL
                                    : inst instanceof INVOKESTATIC ? org.apache.bcel.Constants.INVOKESTATIC
                                            : inst instanceof INVOKEVIRTUAL ? org.apache.bcel.Constants.INVOKEVIRTUAL
                                                    : -1;
                    ih.swapInstruction(ifc.createInvoke(transformName(ii.getClassName(cpg)), ii.getMethodName(cpg),
                            transformType(ii.getReturnType(cpg)), transformTypes(ii.getArgumentTypes(cpg)), itype));
                    if (org.apache.bcel.Constants.CONSTRUCTOR_NAME.equals(ii.getMethodName(cpg))
                        ...
                        il.append(ifc.createInvoke(transformName(ii.getClassName(cpg)), "_jistPostInit", Type.VOID,
                                Type.NO_ARGS, org.apache.bcel.Constants.INVOKEVIRTUAL));
            ...
            if (inst instanceof NEW) {
                ...
                if (shouldTransformType(ni.getType(cpg))) {
                    ih.swapInstruction(ifc.createNew((ObjectType) transformType(ni.getType(cpg))));
                }
            }
            ...
            if (inst instanceof ANEWARRAY) {
                ...
                if (shouldTransformType(nai.getType(cpg))) {
                    ih.swapInstruction(ifc.createNewArray(transformType(nai.getType(cpg)), (short) 1));
