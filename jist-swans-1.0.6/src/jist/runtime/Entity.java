 ...
 * objects are rewritten to implement. This interface is an internal one (should
 * not be mentioned in simulation program) and allows the JiST system to manage
 * JistAPI.Entity objects.
 * 
