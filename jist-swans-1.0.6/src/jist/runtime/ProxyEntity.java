...
final class ProxyEntity extends Entity.Empty {
	 ...
	 */
	protected static String[] isValidProxyEntity(Object proxyTarget,
	...
	public static Object create(Object proxyTarget, Class[] proxyInterface) {
		...
		if (proxyTarget instanceof JistAPI.Proxiable) {
			...
			Proxy pe = (Proxy) Proxy.newProxyInstance(proxyTarget.getClass()
					.getClassLoader(), proxyInterface, new ProxyEntityHandler(
					proxyTarget));
		...
		Proxy per = (Proxy) Proxy.newProxyInstance(
				proxyInterface[0].getClassLoader(), proxyInterface, ref);
		return per;
	}
