...
// Timestamp: <ClassTraversal.java Tue 2004/04/06 11:22:39 barr
...
public class ClassTraversal
{
     ...
     */
    protected void processInstruction(ClassGen cg, MethodGen mg, InstructionHandle[] ihs, int i)
    ...
    public static interface Visitor
    {
         ...
         */
        void doInstruction(ClassGen cg, MethodGen mg, InstructionHandle ih, Instruction i)
                throws ClassNotFoundException;
    ...
    public static class Empty implements Visitor
    {
        ...
        /** {@inheritDoc} */
        public void doInstruction(ClassGen cg, MethodGen mg, InstructionHandle ih, Instruction i)
                throws ClassNotFoundException {
        }
