...
public class GuiLog
{
    ...
    public static class MouseAdapterHandler extends MouseAdapter
    {
        ...
        public void mouseClicked(MouseEvent e) {
            ...
            int y = rowHeight * jumpRow; // y-coordinate of top-left corner of
                                         // new rectangle view
            int width = (int) clickedTable.getPreferredScrollableViewportSize().getHeight(); // width
                                                                                             // of
                                                                                             // new
                                                                                             // rectangle
                                                                                             // view
            int height = (int) clickedTable.getPreferredScrollableViewportSize().getHeight(); // height
                                                                                              // of
                                                                                              // new
                                                                                              // rectangle
                                                                                              // view
    ...
    public class EventCellRenderer extends DefaultTableCellRenderer
    {
         ...
         * @return Component
         */
        public synchronized Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected,
            ...
            cell.setOpaque(true);
            cell.setBackground(isSelected ? Color.CYAN : row % 2 == 0 ? Color.WHITE : Color.LIGHT_GRAY);
    ...
    public static class ChildrenCellEditor extends AbstractCellEditor implements TableCellEditor, ActionListener
    {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            int y = rowHeight * jumpRow; // y-coordinate of top-left corner of
                                         // new rectangle view
            int width = (int) table.getPreferredScrollableViewportSize().getWidth(); // width
                                                                                     // of
                                                                                     // new
                                                                                     // rectangle
                                                                                     // view
            int height = (int) table.getPreferredScrollableViewportSize().getHeight(); // height
                                                                                       // of
                                                                                       // new
                                                                                       // rectangle
                                                                                       // view
    ...
    public static void untilTimer() {
        ...
        int numSeconds = Integer.parseInt((String) JOptionPane.showInputDialog(frame,
    ...
    static {
        try {
            m = GuiLog.class.getDeclaredMethod("main", new Class[] { String[].class });
