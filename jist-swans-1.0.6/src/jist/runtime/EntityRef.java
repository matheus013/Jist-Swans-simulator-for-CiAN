...
/**
 * Stores a reference to a (possibly remote) Entity object. A reference consists
 * of a serialized reference to a Controller and an index within that
 * Controller.
 * 
...
public class EntityRef implements InvocationHandler {
	 ...
	 * 
	 * @param proxy
	 *            proxy entity reference object whose method was invoked
	 * @param method
	 *            method invoked on entity reference object
	 * @param args
	 *            arguments of the method invocation
	 * @return result of blocking event; null return for non-blocking events
	 * @throws Throwable
	 *             whatever was thrown by blocking events; never for
	 *             non-blocking events
	 */
	...
	/**
	 * Helper method: called whenever a BLOCKING method on proxy entity
	 * reference is invoked. Schedules the call at the appropriate Controller.
	 * 
	 * @param proxy
	 *            proxy entity reference object whose method was invoked
	 * @param method
	 ...
	 */
	private Object blockingInvoke(Object proxy, Method method, Object[] args)
			throws Throwable {
