...
public final class JistAPI_Impl extends JistAPI {
	...
	static {
		try {
			method_getTime = JistAPI_Impl.class.getDeclaredMethod("getTime",
					new Class[] {});
			method_sleep = JistAPI_Impl.class.getDeclaredMethod("sleep",
					new Class[] { Long.TYPE });
			method_sleepBlock = JistAPI_Impl.class.getDeclaredMethod(
					"sleepBlock", new Class[] { Long.TYPE });
			method_sleepBlockAPI = JistAPI.class.getDeclaredMethod(
					"sleepBlock", new Class[] { Long.TYPE });
			method_ref = JistAPI_Impl.class.getDeclaredMethod("ref",
					new Class[] { Object.class });
			method_end = JistAPI_Impl.class.getDeclaredMethod("end",
					new Class[] {});
			method_endAt = JistAPI_Impl.class.getDeclaredMethod("endAt",
					new Class[] { Long.TYPE });
			method_callStaticAt = JistAPI_Impl.class.getDeclaredMethod(
					"callStaticAt", new Class[] { Method.class, Object[].class,
							Long.TYPE });
			method_runAt = JistAPI_Impl.class.getDeclaredMethod("runAt",
					new Class[] { Runnable.class, Long.TYPE });
			method_proxy = JistAPI_Impl.class.getDeclaredMethod("proxy",
					new Class[] { Object.class, Class.class });
			method_proxyMany = JistAPI_Impl.class.getDeclaredMethod(
					"proxyMany", new Class[] { Object.class, Class[].class });
			method_createChannel = JistAPI_Impl.class.getDeclaredMethod(
					"createChannelImpl", new Class[] {});
			method_installRewrite = JistAPI_Impl.class.getDeclaredMethod(
					"installRewrite",
					new Class[] { ClassTraversal.Visitor.class });
			method_run = JistAPI_Impl.class.getDeclaredMethod("run",
					new Class[] { Integer.TYPE, String.class, String[].class,
							Object.class });
			method_setSimUnits = JistAPI_Impl.class.getDeclaredMethod(
					"setSimUnits", new Class[] { Long.TYPE, String.class });
			method_getTimeString = JistAPI_Impl.class.getDeclaredMethod(
					"getTimeString", new Class[] {});
			method_setLog = JistAPI_Impl.class.getDeclaredMethod("setLog",
					new Class[] { JistAPI.Logger.class });
			method_log = JistAPI_Impl.class.getDeclaredMethod("log",
					new Class[] { String.class });
			method_isEntity = JistAPI_Impl.class.getDeclaredMethod("isEntity",
					new Class[] { Object.class });
			method_toString = JistAPI_Impl.class.getDeclaredMethod("toString",
					new Class[] { Object.class });
	...
	public static void sleepBlock(long i) throws JistAPI.Continuable {
		try {
			Controller.entityInvocationCont(
					BlockingSleep._jistMethodStub_sleep_28J_29V, Controller
							.getActiveController().entityBlockingSleep
							._jistMethod_Get__ref(),
					new Object[] { new Long(i) });
		} catch (Throwable e) {
			throw new JistException(
					"unexpected exception during blocking sleep", e);
		}
	}

	/** @see JistAPI */
	public static Object ref(Object o) {
		return o instanceof jist.runtime.Entity ? ((jist.runtime.Entity) o)
				._jistMethod_Get__ref() : o; // will always be EntityRef, we
												// save the cast
	}
	...
	public static void runAt(Runnable r, long time) {
		callStaticAt(Bootstrap.StaticRunnableCaller.method_run,
				new Object[] { r }, time);
	}
	...
	/** @see JistAPI */
	public static void run(int type, String name, String[] args,
			Object properties) {
		try {
			Bootstrap.create(type, Controller.getActiveController(), name,
					args, properties);
	...
	public static boolean isEntity(Object o) {
		try {
			return o instanceof EntityRef
					|| (Proxy.isProxyClass(o.getClass()) && Proxy
							.getInvocationHandler(o) instanceof EntityRef);
