...
// Timestamp: <JistAPI_Impl.java Thu 2005/02/24 23:11:11 barr
...
public final class JistAPI_Impl extends JistAPI
{
    ...
    /**
     * Method stub field for determining whether a reference is an entity
     * reference.
     */
    ...
    static {
        try {
            method_getTime = JistAPI_Impl.class.getDeclaredMethod("getTime", new Class[] {});
            method_sleep = JistAPI_Impl.class.getDeclaredMethod("sleep", new Class[] { Long.TYPE });
            method_sleepBlock = JistAPI_Impl.class.getDeclaredMethod("sleepBlock", new Class[] { Long.TYPE });
            method_sleepBlockAPI = JistAPI.class.getDeclaredMethod("sleepBlock", new Class[] { Long.TYPE });
            method_ref = JistAPI_Impl.class.getDeclaredMethod("ref", new Class[] { Object.class });
            method_end = JistAPI_Impl.class.getDeclaredMethod("end", new Class[] {});
            method_endAt = JistAPI_Impl.class.getDeclaredMethod("endAt", new Class[] { Long.TYPE });
            method_callStaticAt = JistAPI_Impl.class.getDeclaredMethod("callStaticAt", new Class[] { Method.class,
            Object[].class, Long.TYPE });
            method_runAt = JistAPI_Impl.class.getDeclaredMethod("runAt", new Class[] { Runnable.class, Long.TYPE });
            method_proxy = JistAPI_Impl.class.getDeclaredMethod("proxy", new Class[] { Object.class, Class.class });
            method_proxyMany = JistAPI_Impl.class.getDeclaredMethod("proxyMany", new Class[] { Object.class,
            Class[].class });
            method_createChannel = JistAPI_Impl.class.getDeclaredMethod("createChannelImpl", new Class[] {});
            method_installRewrite = JistAPI_Impl.class.getDeclaredMethod("installRewrite",
                    new Class[] { ClassTraversal.Visitor.class });
            method_run = JistAPI_Impl.class.getDeclaredMethod("run", new Class[] { Integer.TYPE, String.class,
            String[].class, Object.class });
            method_setSimUnits = JistAPI_Impl.class.getDeclaredMethod("setSimUnits", new Class[] { Long.TYPE,
            String.class });
            method_getTimeString = JistAPI_Impl.class.getDeclaredMethod("getTimeString", new Class[] {});
            method_setLog = JistAPI_Impl.class.getDeclaredMethod("setLog", new Class[] { JistAPI.Logger.class });
            method_log = JistAPI_Impl.class.getDeclaredMethod("log", new Class[] { String.class });
            method_isEntity = JistAPI_Impl.class.getDeclaredMethod("isEntity", new Class[] { Object.class });
            method_toString = JistAPI_Impl.class.getDeclaredMethod("toString", new Class[] { Object.class });
    ...
    public static void sleepBlock(long i) throws JistAPI.Continuable {
        try {
            Controller.entityInvocationCont(BlockingSleep._jistMethodStub_sleep_28J_29V,
    ...
    public static Object ref(Object o) {
        return o instanceof jist.runtime.Entity ? ((jist.runtime.Entity) o)._jistMethod_Get__ref() : o; // will
                                                                                                        // always
                                                                                                        // be
                                                                                                        // EntityRef,
                                                                                                        // we
    ...
    /**
     * Actual implementation of <code>createChannel</code> method; returns new
