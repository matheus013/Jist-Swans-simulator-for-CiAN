...
public class RemoteIO {
	...
	public static class RemoteInputStream extends InputStream {
		 ...
		 *             underlying input/output error
		 */
		public RemoteInputStream(RemoteInputStreamRemote rin)
				throws IOException {
			this.rin = rin;
		}
	 ...
	 */
	public static class RemoteInputStreamSender extends UnicastRemoteObject
	 ...
	 */
	public static class RemoteInputStreamSenderLocal implements
			RemoteInputStreamRemote {
		/**
		 * Underlying input stream, source of all data.
		 */
		private InputStream lin;
	 ...
	 */
	public static class RemoteOutputStreamReceiver extends UnicastRemoteObject
		 ...
		 * 
		 * @param lout
		 *            underlying destination output stream
		 * @throws RemoteException
		 *             rpc failure
		 */
		public RemoteOutputStreamReceiver(OutputStream lout)
				throws RemoteException {
			this.lout = lout;
		}
	 ...
	 */
	public static class RemoteOutputStreamReceiverLocal implements
			RemoteOutputStreamRemote {
		/**
		 * Underlying output stream, destination of all data.
		 */
		private OutputStream lout;
	...
	/**
	 * A special PrintStream that *does* throw exceptions. Used for creating a
	 * substitute System.stdout, which fail abruptly on detecting client/server
	 * network failure.
	 */
