...
// Timestamp: <RemoteJist.java Tue 2004/04/06 11:24:46 barr
...
public class RemoteJist
{
    ...
    public static class JobQueueServer extends UnicastRemoteObject implements JobQueueServerRemote
    {
         ...
         *             rpc failure
         */
        public static JobQueueServerRemote getRemote(Node n) throws NotBoundException, MalformedURLException,
                RemoteException {
    ...
    public static class RemoteClassLoader extends ClassLoader
    {
        ...
        public Class loadClass(String name, boolean resolve) throws ClassNotFoundException {
            ...
            return Rewriter.isIgnoredStatic(name) ? super.loadClass(name, resolve) : this.findClass(name);
        }
     ...
     */
    public static interface JistClientRemote extends PingRemote, ResourceFinderRemote, Remote
    {
        /**
     ...
     */
    public static class JistClient extends UnicastRemoteObject implements RemoteJist.JistClientRemote
    {
