...
public interface ControllerRemote extends Remote {
	...
	/**
	 * Start the Controller processing thread with given rewriter instance. The
	 * thread will die when there are no more events to process, or simulation
	...
	/**
	 * Insert event in into event queue (performance: avoids need to get
	 * controller instance to create event - shaves off around 10%).
	 * 
	 * @param meth
	 *            method of event to schedule
	 * @param ref
	 *            entity reference of event to schedule
	 * @param params
	 *            parameters of event to schedule
	 * @throws RemoteException
	 *             rpc failure
	 */
	void addEvent(Method meth, EntityRef ref, Object[] params)
			throws RemoteException;
	 ...
	 *             rpc failure
	 */
	void addEvent(Method meth, EntityRef ref, Object[] params, long time)
			throws RemoteException;
