...
/**
 * Implements a single-slot channel ala Communicating Sequential Processes (CSP)
 * by Hoare. Other synchronization primitives can be built atop this structure,
 * or directly using the same idea. This Channel implementation may not block
 * the sender, and may drop excessive sends by setting flags accordingly.
 * 
...
public class Channel extends Entity.Empty implements JistAPI.Entity
{
    ...
    static {
        try {
            _jistMethodStub_receive_28_29Ljava_2elang_2eObject_3b = Channel.class.getDeclaredMethod("receive",
                    new Class[] {});
            _jistMethodStub_send_28Ljava_2elang_2eObject_3b_29V = Channel.class.getDeclaredMethod("send",
                    new Class[] { Object.class });
            _jistMethodStub_send_28Ljava_2elang_2eObject_3bZZ_29V = Channel.class.getDeclaredMethod("send",
                    new Class[] { Object.class, Boolean.TYPE, Boolean.TYPE });
            _jistMethodStub_sendNonBlock_28Ljava_2elang_2eObject_3b_29V = Channel.class.getDeclaredMethod(
                    "sendNonBlock", new Class[] { Object.class });
            _jistMethodStub_sendNonBlock_28Ljava_2elang_2eObject_3bZZ_29V = Channel.class.getDeclaredMethod(
                    "sendNonBlock", new Class[] { Object.class, Boolean.TYPE, Boolean.TYPE });
     ...
     * @param data
     *            object to transmit
     * @param shouldDropIfFull
     *            whether over-sent channel should throw exception or silently
     *            drop
     * @param shouldDropIfNotReceiveWaiting
     *            whether send should be dropped if no receive is waiting
     * @param shouldBlockSender
     *            whether sender should be blocked
     */
    private void send(Object data, boolean shouldDropIfFull, boolean shouldDropIfNotReceiveWaiting,
            boolean shouldBlockSender) {
        try {
            if (shouldDropIfNotReceiveWaiting && blockedReceiver == null)
                return;
            if (hasData) {
                if (shouldDropIfFull)
                    return;
     ...
     *            whether over-sent channel should throw exception or silently
     *            drop
     * @param shouldDropIfNoReceiveWaiting
     *            whether send should be dropped if no receive is waiting
     * @throws JistAPI.Continuation
     *             never (merely a rewriter tag)
     */
    public void send(Object data, boolean shouldDropIfFull, boolean shouldDropIfNoReceiveWaiting)
            throws JistAPI.Continuation {
     ...
     *            whether send should be dropped if no receive is waiting
     */
    public void sendNonBlock(Object data, boolean shouldDropIfFull, boolean shouldDropIfNoReceiveWaiting) {
     ...
     * 
     * @param data
     *            data to insert into the channel
     */
