...
public class Channel extends Entity.Empty implements JistAPI.Entity {
	...
	static {
		try {
			_jistMethodStub_receive_28_29Ljava_2elang_2eObject_3b = Channel.class
					.getDeclaredMethod("receive", new Class[] {});
			_jistMethodStub_send_28Ljava_2elang_2eObject_3b_29V = Channel.class
					.getDeclaredMethod("send", new Class[] { Object.class });
			_jistMethodStub_send_28Ljava_2elang_2eObject_3bZZ_29V = Channel.class
					.getDeclaredMethod("send", new Class[] { Object.class,
							Boolean.TYPE, Boolean.TYPE });
			_jistMethodStub_sendNonBlock_28Ljava_2elang_2eObject_3b_29V = Channel.class
					.getDeclaredMethod("sendNonBlock",
							new Class[] { Object.class });
			_jistMethodStub_sendNonBlock_28Ljava_2elang_2eObject_3bZZ_29V = Channel.class
					.getDeclaredMethod("sendNonBlock", new Class[] {
							Object.class, Boolean.TYPE, Boolean.TYPE });
