...
public class JistAPI {
	...
	public static interface CustomRewriter {
		 ...
		 */
		org.apache.bcel.classfile.JavaClass process(
				org.apache.bcel.classfile.JavaClass jcl)
	...
	/**
	 * Advance the current simulation time, and block current method (using
	 * simulation time continuations) until that time. Note that sleep() is far
	 * less expensive in the current implementation. SleepBlock requires two
	 * events and to store the continuation... a considerable overhead in
	 * comparison.
	 * 
	 * @param i
	 *            number of time steps to advance simulation time
	 ...
	 * 
	 * @param time
	 *            simulation time at which to end simulation
	 */
	public static void endAt(long time) {
		if (Main.isRunning())
			JistAPI_Impl.endAt(time);
	}
	 ...
	 *            method to invoke
	 * @param params
	 *            parameters of invocation
	 * @param time
	 *            simulation invocation time
	 */
	 ...
	 * @param properties
	 *            values passed to the bootstrap agent
	 */
	 ...
	 * 
	 * @param ticks
	 *            number of simulation ticks per unit
	 * @param name
	 *            time unit of measure name
	 */
	public static void setSimUnits(long ticks, String name) {
		if (Main.isRunning())
			JistAPI_Impl.setSimUnits(ticks, name);
	}
