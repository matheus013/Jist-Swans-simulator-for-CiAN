...
// Timestamp: <Bootstrap.java Tue 2004/04/06 11:22:28 barr
...
public abstract class Bootstrap extends Entity.Empty
{
    ...
    static {
        try {
            method_startSimulation = Bootstrap.class.getDeclaredMethod("startSimulation", new Class[] { Rewriter.class,
     ...
     */
    public static void create(int type, Controller controller, String name, String[] args, Object properties)
            throws RemoteException {
        ...
        controller.addEvent(new Event(controller.getSimulationTime(), Bootstrap.method_startSimulation, simEntity
                ._jistMethod_Get__ref(), new Object[] { cll, name, args, properties }));
    }
    ...
    static class StaticRunnableCaller
    {
        ...
        static {
            try {
                method_run = StaticRunnableCaller.class.getDeclaredMethod("run", new Class[] { Runnable.class });
            } catch (NoSuchMethodException e) {
                throw new JistException("should not happen", e);
            }
        }
