...
final class Pickle {
	...
	/**
	 * Print a hex-dump of some portion of a byte-array to System standard
	 * output stream.
	 * 
	 * @param a
	 *            array to print
	...
	/**
	 * Print a hex-dump of some portion of a byte-array to System.out followed
	 * by a new line.
	 * 
	 * @param a
	 *            array to print
	 ...
	 * @param offset
	 *            location in array to begin conversion
	 * @param length
	 ...
	 * @param offset
	 *            locationin array to begin conversion
	 * @param length
	 *            number of bytes to convert
	 ...
	 * @param offset
	 *            offset within array to store integer at (4 bytes)
	 */
	 ...
	 *            destination byte array
	 * @param offset
	 *            offset within array to store short at (2 bytes)
	 */
	 ...
	 * 
	 * @param inet
	 *            Internet address to convert
	 * @param b
	 *            destination byte array
	 * @param offset
	 *            offset within array to store address at (4 bytes)
	 */
	...
	public static Object arrayToObject(byte[] b, int offset) {
		try {
			int len = arrayToInteger(b, offset);
			ByteArrayInputStream bais = new ByteArrayInputStream(b, offset + 4,
					len);
			ObjectInputStream ois = new ObjectInputStream(bais);
			return ois.readObject();
		} catch (IOException e) {
			e.printStackTrace();
			throw new JistException("unable to deserialize packet (io error)",
					e);
		} catch (ClassNotFoundException e) {
			e.printStackTrace();
			throw new JistException(
					"unable to deserialize packet (class not found)", e);
		}
	}
