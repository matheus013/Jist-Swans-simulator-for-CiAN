...
// Timestamp: <Controller.java Sun 2005/03/13 11:10:28 barr
...
public final class Controller implements ControllerRemote, Runnable
{
    ...
    static {
        try {
            method_getTHIS = Controller.class.getDeclaredMethod("getTHIS", new Class[] {});
            ...
            method_entityInvocation = Controller.class.getDeclaredMethod("entityInvocation", new Class[] {
            Method.class, Object.class, Object[].class });
            method_entityInvocationCont = Controller.class.getDeclaredMethod("entityInvocationCont", new Class[] {
            Method.class, Object.class, Object[].class });
            method_popStateInFrame = Controller.class.getDeclaredMethod("popStateInFrame", new Class[] {});
            method_pushStateOutFrame = Controller.class.getDeclaredMethod("pushStateOutFrame",
                    new Class[] { Event.ContinuationFrame.class });
            method_isModeRestore = Controller.class.getDeclaredMethod("isModeRestore", new Class[] {});
            method_isModeSave = Controller.class.getDeclaredMethod("isModeSave", new Class[] {});
     ...
     * GUI logger.
     */
    public static final GuiLog          guilog           = Main.GUILOG_SIZE > 0 ? new GuiLog(Main.GUILOG_SIZE) : null;
    ...
    public void run() {
        ...
        try {
            ...
            if (numEvents > 0) {
                ...
                log.info("TOTAL: " + Util.getHMS((long) seconds) + " real, " + getSimulationTimeString() + " sim, "
    ...
    private void processEvent() {
        ...
        try {
            ...
            if (t instanceof JistException)
                ...
                throw new JistException("application exception propagated to event loop", e.getTargetException());
        } catch (JistException e) {
            throw e;
        } catch (Exception e) {
    ...
    public static EntityRef getEntityReference(Object o) {
        return o instanceof Entity ? ((Entity) o)._jistMethod_Get__ref() : (EntityRef) o;
    }
    ...
    public static void entityInvocation(Method meth, Object callee, Object[] params) {
        entityInvocation(meth,
                callee instanceof EntityRef ? (EntityRef) callee : ((Entity) callee)._jistMethod_Get__ref(), params);
    }
     ...
     */
    public static Object entityInvocationCont(Method meth, EntityRef ref, Object[] params) throws JistAPI.Continuation,
            Throwable {
     ...
     *             whatever was thrown by blocking event
     */
    public static Object entityInvocationCont(Method meth, Entity entity, Object[] params) throws JistAPI.Continuation,
            Throwable {
     ...
     *             whatever was thrown by blocking event
     */
    public static Object entityInvocationCont(Method meth, Object callee, Object[] params) throws JistAPI.Continuation,
            Throwable {
     ...
     *             invalid logger class
     */
    public void setLog(Class loggerClass) throws InstantiationException, IllegalAccessException {
