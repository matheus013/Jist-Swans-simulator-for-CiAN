...
// Timestamp: <BlockingSleep.java Thu 2005/02/24 21:19:21 barr
...
public class BlockingSleep extends Entity.Empty implements JistAPI.Entity
{
    ...
    static {
        try {
            _jistMethodStub_sleep_28J_29V = BlockingSleep.class.getDeclaredMethod("sleep", new Class[] { Long.TYPE });
