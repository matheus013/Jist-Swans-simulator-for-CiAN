...
// Timestamp: <JistException.java Tue 2004/04/06 11:23:55 barr
...
class JistException extends Error
{
    ...
    public static class JistSimulationEndException extends JistException
    {
        ...
        static {
            try {
                method_end = JistSimulationEndException.class.getDeclaredMethod("end", new Class[] {});
        ...
        /**
         * Ends simulation immediately when called. Usually call to this method
         * is scheduled via the JistAPI.end() method.
         */
