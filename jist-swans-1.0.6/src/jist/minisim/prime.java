...
/**
 * Pulls in all the classes that it find below a given classpath in order to get
 * rewriter statistics.
 * 
...
public class prime {
	...
	private static void showVersion() {
		System.out.println("JiST primer v" + VERSION
	...
	private static void showUsage() {
		...
		System.out
				.println("  -d, --dir          base classfile directory ['.']");
	...
	public static class ClassFileFilter implements FilenameFilter {
		...
		public boolean accept(File dir, String name) {
			return name.endsWith(".class") && (new File(dir, name)).isFile();
		}
	}
	 ...
	 *            directory path
	 * @param base
	 *            relative path from package root directory
	 */
