...
/**
 * An example to show why you don't always need threads in an event-oriented
 * environment. Run this code under both java and jist to see how jist provides
 * simulation time 'parallelism' without threads.
 * 
