...
public final class contproxy {
	...
	private static void showVersion() {
		System.out.println("JiST continuation micro-benchmark v" + VERSION
	...
	private static cmdlineOpts parseCommandLineOptions(String[] args)
		...
		if (parser.getOptionValue(opt_warm) != null) {
			options.warm = Long.parseLong((String) parser
					.getOptionValue(opt_warm));
		}
	...
	public static void main(String[] args) {
		try {
			...
			entityInterface ei = (entityInterface) JistAPI.proxy(e,
	...
	public static class entity implements entityInterface {
		 ...
		 *            benchmark type
		 * @param nevents
		 *            number of proxied blocking benchmark events
		 * @param nwarm
		 *            number of proxied blocking warm-up events
		 */
