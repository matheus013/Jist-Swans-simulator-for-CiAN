...
public class isentity
{
    ...
    /**
     * Program entry point: Test different kinds of references with JistAPI
     * isEntity.
     * 
     * @param args
    ...
    public static void main(String[] args) {
        ...
        System.out.println("proxied:   " + JistAPI.isEntity(JistAPI.proxy(new myObject(), myObjectInterface.class)));
