...
/**
 * A slightly more sophisticated Hello World of simulations to show the
 * difference between blocking and non-blocking events.
 * 
...
public class hello_loop implements JistAPI.Entity {
	 ...
	 */
	public hello_loop() {
		System.out.println("Creating new object hello_loop at t = "
				+ JistAPI.getTime());
	}
