    ...
    public static class Server
    {
        public static void main(String args[]) {
            try {
                ...
                socket.close();
                System.out.println("received at t=" + JistAPI.getTime() + " (" + packet.getLength() + " bytes) "
    ...
    public static class Client
    {
        public static void main(String args[]) {
            try {
                ...
                DatagramPacket packet = new DatagramPacket(buf, buf.length, InetAddress.getByAddress(SERVER_IP), PORT);
