...
public class dsrtest {
	...
	public static class Client {
		public static void main(String args[]) {
			try {
				...
				DatagramPacket packet = new DatagramPacket(buf, buf.length,
						InetAddress.getByAddress(SERVER_IP), PORT);
	...
	private static void TwoNodeTest() {
		try {
			...
			// mac
			Mac802_11 mac1 = new Mac802_11(new MacAddress(i),
					radio1.getRadioInfo());
			Mac802_11 mac2 = new Mac802_11(new MacAddress(i + 1),
					radio2.getRadioInfo());
			// net
	...
	private static void ThreeNodeTest() {
		try {
			...
			Mac802_11 mac2 = new Mac802_11(new MacAddress(i + 1),
					radio2.getRadioInfo());
			Mac802_11 mac3 = new Mac802_11(new MacAddress(i + 2),
					radio2.getRadioInfo());
			// net
			NetIp net1 = new NetIp(new NetAddress(SERVER_IP), protMap, pl, pl);
			NetIp net2 = new NetIp(new NetAddress(i), protMap, pl, pl);
