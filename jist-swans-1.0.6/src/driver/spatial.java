...
public class spatial {
	...
	private static void showVersion() {
		System.out.println("JiST Project: Spatial data structure performance v"
				+ VERSION);
		System.out
	...
	public static Field createSim(Location.Location2D bounds, Spatial spatial,
		...
		Field field = new Field(spatial, fading, pathloss, null,
	...
	public static void main(String[] args) {
		try {
			...
			System.out.println("done.");
			/*
			 * // count bins Spatial.LinearList.NUM = 0;
			 * f.computeAvgConnectivity(false); double numbins =
			 * Spatial.LinearList.NUM/(double)options.num; // results
			 * System.out.println("seconds: "+((endTime-startTime)/1000.0)
			 * +" bins="+numbins +" work="+(numbins*StrictMath.max(nodebin,1)));
			 */
