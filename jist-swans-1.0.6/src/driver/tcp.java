...
public class tcp {
	...
	public static class Server {
		/**
		 * TCP server entry point: open TCP socket and receive message from
		 * client.
		 * 
		 * @param args
		...
		public static void main(String[] args) {
			...
			System.out
					.println("tcp server: starting at t=" + JistAPI.getTime());
			...
			try {
				...
				System.err.println("tcp server: Could not listen on port "
						+ PORT);
				System.exit(-1);
			}
	...
	public static class Client {
		/**
		 * TCP client entry point: open TCP socket and send off message to
		 * server.
		 * 
		 * @param args
		 *            command-line parameters
		...
		public static void main(String[] args) {
			...
			System.out
					.println("tcp client: starting at t=" + JistAPI.getTime());
			...
			try {
				...
				System.out.println("tcp client: sent at t=" + JistAPI.getTime()
						+ "(" + msg_bulk.length + " bytes)");
	...
	/**
	 * Program entry point: small TCP test that can be run inside and outside of
	 * JiST.
	 * 
	 * @param args
	 *            command-line parameters
