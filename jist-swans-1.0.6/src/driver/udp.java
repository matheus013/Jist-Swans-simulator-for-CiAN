...
public class udp {
	...
	public static class Server {
		/**
		 * UDP server entry point: open UDP socket and wait for single packet
		 * from client.
		 * 
		 * @param args
		...
		public static void main(String[] args) {
			try {
				...
				do {
					...
					received++;
					System.out.println("received at t="
							+ JistAPI.getTime()
							+ " ("
							+ packet.getLength()
							+ " bytes) "
	...
	public static class Client {
		...
		public static void main(String[] args) {
			try {
				...
				System.out.println("terminate packet sent at t="
						+ JistAPI.getTime());
				System.out.flush();
				buf = new byte[0];
	...
	/**
	 * Program entry point: small UDP test that can be run inside and outside of
	 * JiST.
	 * 
	 * @param args
	 *            command-line parameters
