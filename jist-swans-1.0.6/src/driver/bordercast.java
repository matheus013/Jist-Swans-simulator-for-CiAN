...
// Timestamp: <bordercast.java Tue 2004/04/06 11:57:42 barr
...
public class bordercast
{
    ...
    private static CommandLineOptions parseCommandLineOptions(String[] args) throws CmdLineParser.OptionException {
        ...
        if (parser.getOptionValue(opt_protocol) != null) {
            ...
            cmdOpts.protocolOpts = Util.stringJoin(
                    (String[]) Util.rest(((String) parser.getOptionValue(opt_protocol)).split(":")), ":");
        }
        // ndp
        if (parser.getOptionValue(opt_ndp) != null) {
            ...
            cmdOpts.ndpOpts = Util.stringJoin(
                    (String[]) Util.rest(((String) parser.getOptionValue(opt_ndp)).split(":")), ":");
        }
        // iarp
        if (parser.getOptionValue(opt_iarp) != null) {
            ...
            cmdOpts.iarpOpts = Util.stringJoin(
                    (String[]) Util.rest(((String) parser.getOptionValue(opt_iarp)).split(":")), ":");
        }
        // brp
        if (parser.getOptionValue(opt_brp) != null) {
            ...
            cmdOpts.brpOpts = Util.stringJoin(
                    (String[]) Util.rest(((String) parser.getOptionValue(opt_brp)).split(":")), ":");
        }
        // ierp
        if (parser.getOptionValue(opt_ierp) != null) {
            ...
            cmdOpts.ierpOpts = Util.stringJoin(
                    (String[]) Util.rest(((String) parser.getOptionValue(opt_ierp)).split(":")), ":");
        }
        // nodes
        ...
        if (parser.getOptionValue(opt_bordercast) != null) {
            ...
            if (data.length != 3)
                throw new CmdLineParser.IllegalOptionValueException(opt_bordercast, "bad format: num,locs,start,delay");
        ...
        if (parser.getOptionValue(opt_spatial) != null) {
            ...
            String spatialOpts = Util.stringJoin(
                    (String[]) Util.rest(((String) parser.getOptionValue(opt_spatial)).split(":")), ":");
            if (spatialString != null) {
                if (spatialString.equalsIgnoreCase("linear")) {
                    ...
                    throw new CmdLineParser.IllegalOptionValueException(opt_spatial,
                            "unrecognized spatial binning model");
                }
            }
        }
     ...
     */
    public static void addNode(CommandLineOptions opts, int i, Vector routers, RouteZrp.ZrpStats stats, Field field,
    ...
    private static void buildField(CommandLineOptions opts, final Vector routers, final RouteZrp.ZrpStats stats) {
        ...
        for (int i = 1; i <= opts.nodes; i++) {
            JistAPI.callStaticAt(method_addNode, new Object[] { opts, new Integer(i), routers, stats, field, place,
                    radioInfo, protMap, inLoss, outLoss }, i);
        }
