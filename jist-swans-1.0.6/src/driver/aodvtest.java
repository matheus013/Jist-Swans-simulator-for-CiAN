...
public class aodvtest
{
    ...
    public static class MyServer
    {
        public static void main(String[] args) {
            try {
                ...
                socket.close();
                System.out.println("server received at t=" + JistAPI.getTime() + " (" + packet.getLength() + " bytes) "
    ...
    public static class MyClient
    {
        ...
        public static void main(String args[]) {
            ...
            try {
                ...
                socket.send(packet);
                /*
                 * for (int i=0; i<10; i++) { socket.send(packet);
     ...
     *            protocol mapper
     * @param appClass
     *            class of application to run at this node
     */
    public static void createNode(int i, Field field, float x, float y, RadioInfo.RadioInfoShared radioInfoShared,
            Mapper protMap, Class appClass, PacketLoss plIn, PacketLoss plOut) {
        // create entities
    ...
    public static void createSim() {
        ...
        createNode(CLIENT_ID, field, 0, 0, radioInfoShared, protMap, MyClient.class, plIn, plOut);
        ...
        // createNode(4, field, 800, 800, radioInfoShared, protMap, null, plIn,
        // plOut);
        ...
        createNode(SERVER_ID, field, 800, 800, radioInfoShared, protMap, MyServer.class, plIn, plOut);
