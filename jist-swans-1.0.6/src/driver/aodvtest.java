...
public class aodvtest {
	...
	public static class MyServer {
		public static void main(String[] args) {
			try {
				...
				socket.close();
				System.out.println("server received at t="
						+ JistAPI.getTime()
						+ " ("
						+ packet.getLength()
						+ " bytes) "
	 ...
	 */
	public static void createNode(int i, Field field, float x, float y,
			RadioInfo.RadioInfoShared radioInfoShared, Mapper protMap,
			Class appClass, PacketLoss plIn, PacketLoss plOut) {
		// create entities
	...
	public static void createSim() {
		...
		createNode(CLIENT_ID, field, 0, 0, radioInfoShared, protMap,
				MyClient.class, plIn, plOut);

		// create intermediate node
		System.out.println("Starting intermediate node...");
		createNode(INTERM_ID, field, 400, 400, radioInfoShared, protMap, null,
				plIn, plOut);
		...
		createNode(SERVER_ID, field, 800, 800, radioInfoShared, protMap,
				MyServer.class, plIn, plOut);
