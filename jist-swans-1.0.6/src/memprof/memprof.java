 ...
 * <code>java -Xrunmemprof[:&lt;filename&gt;]</code> where the filename is
 * optional. If omitted, the memory profile will be dumped on standard error. By
 * default, a memory dump will be taken during JVM shutdown, unless a dump has
 * been requested earlier using the <code>dumpHeap</code> function. A memory
 * dump at shutdown may requested nonetheless using the
 * <code>dumpOnShutdown</code> function.
 * 
...
public class memprof {
	...
	static {
		try {
			...
			System.err
					.println("unable to load memprof library; start java with -Xrunmemprof switch");
		}
	}
	 ...
	 * 
	 * @param ident
	 *            some string to print which identifies program location
	 */
	 ...
	 * 
	 * @param ident
	 *            some string identifier for this execution point
	 */
	public static void dumpHeap(String ident) {
		try {
			...
			System.err
					.println("unable to dump heap; start java with -Xrunmemprof switch");
		}
	}
	...
	public static void dumpOnShutdown() {
		try {
			...
			System.err
					.println("unable to schedule shutdown heap dump; start java with -Xrunmemprof switch");
		}
	}
	...
	public static void showVersion() {
		System.out.println("JiST memory profiler v" + VERSION
				+ ", Java in Simulation Time Project.");
		System.out
	...
	public static final void showUsage() {
		...
		System.out
				.println("  java_prog   is:   java program with command-line arguments");
		System.out.println();
	}
