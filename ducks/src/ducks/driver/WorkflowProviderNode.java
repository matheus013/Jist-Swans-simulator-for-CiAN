...
public class WorkflowProviderNode extends GenericNode {
	private static Logger log = Logger.getLogger(WorkflowProviderNode.class
			.getName());

	public WorkflowProviderNode() {
		super();
	}
	...
	protected void addApplication(Mapper protMap, Field field, Placement place)
		...
		if (appOpt.equals(SimParams.TRAFFIC_TYPE_SERVICE)) {
			...
			AppWorkflowBase ac = new AppWorkflowProvider(this.id, compoStats,
					mode, repository, compRestrict);
