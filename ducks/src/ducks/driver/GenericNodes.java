...
public class GenericNodes implements Nodes
{
    ...
    protected ArrayList<Node> createNodes(ExtendedProperties nodeProps, String nodeType, int count, int startNum,
        ...
        RadioInfo.RadioInfoShared radioInfo = RadioInfo.createShared(Constants.FREQUENCY_DEFAULT,
                Constants.BANDWIDTH_DEFAULT, txPower, Constants.GAIN_DEFAULT,
        ...
        if (placement.equals(SimParams.PLACEMENT_MODEL_RANDOM)) {
            ...
            Location2D bounds[] = (Location2D[]) ReflectionUtils.invokeMethod("vans.straw.StreetMobility", "getBounds",
                    null, mob, null);
        ...
        if (globalConfig.getBooleanProperty(SimParams.SCENE_NAMEPSPACE + "." + SimParams.SCENE_STRAWVIZ)) {
            ...
            String mobilityModel = globalConfig.getStringProperty(SimParams.SCENE_NAMEPSPACE + "."
