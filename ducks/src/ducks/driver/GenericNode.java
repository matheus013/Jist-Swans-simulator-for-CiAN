...
public class GenericNode implements Node
{
     ...
     * using this method
     */
    public void setCommonObjects(Placement place, RadioInfoShared radioInfo, Mapper protMap, PacketLoss inLoss,
            PacketLoss outLoss, VisualizerInterface v) {
        this.place = place;
    ...
    protected void addRadio(int id, RadioInfo.RadioInfoShared radioInfo) throws Exception {
        ...
        if (noiseOpt.equals(SimParams.NOISE_TYPE_INDEPENDENT)) {
            ...
            try {
                ...
                // necessary
                radioStats = (DucksRadioNoiseAdditiveStats) stats.getStaticCollector(
                        DucksRadioNoiseAdditiveStats.class, true);
            } catch (Exception e) {
    ...
    protected void addApplication(Mapper protMap, Field field, Placement place) throws Exception {
        ...
        if (appOpt.equals(SimParams.TRAFFIC_TYPE_CBR)) {
            ...
            if (field.getMobility() instanceof StreetMobility) {
                ac = new AppCbrGeo(sendRate, waitTime, wTS, wTE, pPC, this.id, this.nodeCount, duration,
                        field.getRadioData(new Integer(id)), (StreetMobility) field.getMobility());
            } else {
                Location2D fieldsize = new Location2D(globalConfig.getIntProperty(SimParams.SCENE_NAMEPSPACE + "."
                        + SimParams.SCENE_FIELD_SIZE_X), globalConfig.getIntProperty(SimParams.SCENE_NAMEPSPACE + "."
            ...
            AppGeocast appgc = new AppGeocast(this.id, field.getRadioData(new Integer(id)), minRad, maxRad, null,
