...
import ext.jist.swans.app.AppCianNeutral;
import ext.jist.swans.app.AppGreetingBase;
import ext.util.stats.DucksCompositionStats;

public class CianNeutralNode extends GenericNode {
	private static Logger log = Logger.getLogger(CianNeutralNode.class
			.getName());

	public CianNeutralNode() {
		super();
	}
	...
	protected void addApplication(Mapper protMap, Field field, Placement place)
		...
		if (appOpt.equals(SimParams.TRAFFIC_TYPE_SERVICE)) {
			...
			AppCianBase ac = new AppCianNeutral(this.id, compoStats, mode,
