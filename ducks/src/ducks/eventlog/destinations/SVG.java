    ...
    public void logEvent(int node, long time, Location loc, String type, String comment) {
        ...
        if (type.equals("move")) {
            ...
            if (nd == null) {
                ...
                String rect = "<rect id=\"" + node + "\" x=\"" + relWidth + "\" y=\"" + relHeight + "\" height=\""
                        + nodeHeight + "\" width=\"" + nodeWidth + "\" fill=\"" + nodeColor + "\" stroke=\"none\">\n";
                ...
                if (loc.equals(nd.lastLoc) || time == nd.lasttime) {
                    ...
                    String ani = "<animateMotion " + "path=\"M" + x_old + "," + y_old + " " + "L" + x_new + "," + y_new
                            + "\" " + "begin=\"" + (nd.lasttime / Constants.MILLI_SECOND) + "ms\" " + "end=\""
                            + (time / Constants.MILLI_SECOND) + "ms\" " + "dur=\""
                            + ((time - nd.lasttime) / Constants.MILLI_SECOND) + "ms\" "
