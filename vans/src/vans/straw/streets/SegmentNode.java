...
public class SegmentNode extends AStarNode
{
     ...
     */
    public SegmentNode(Location point, int segmentID, boolean start, boolean firstNode) {
        super();
        this.point = point;
    ...
    public float getEstimatedCost(AStarNode node) {
        ...
        /** approximate distance between two points in meters */
            case MANHATTAN_DISTANCE:
                h = (float) (StrictMath.abs(n.point.getX() - end.getX()) + StrictMath.abs(n.point.getY() - end.getY()));
                break;
            default:
