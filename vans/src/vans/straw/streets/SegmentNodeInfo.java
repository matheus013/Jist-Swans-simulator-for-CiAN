 ...
 * RCS: $Id: SegmentNodeInfo.java,v 1.1.1.1 2006/02/20 23:26:44 drchoffnes Exp $
...
public class SegmentNodeInfo
{
     ...
     */
    public SegmentNodeInfo(Vector segment, HashMap shapes, SpatialStreets.HierGrid intersections, HashMap streets,
            Vector segmentNodes) {
        super();
