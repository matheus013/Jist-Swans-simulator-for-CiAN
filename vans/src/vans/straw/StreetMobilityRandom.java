...
public class StreetMobilityRandom extends StreetMobility
{
    ...
    */
	...
	/** Elmar Schoch +++++++++++++++++++++
	 * In the foloowing call, the index value in mobInfo.get(<index>) depends
	 * strongly on how identifiers are assigned to nodes. For instance,
	 * the original STRAW subtracts 1 (i.e. id.intValue()-1)
	 * -----------------------------------
	 */
