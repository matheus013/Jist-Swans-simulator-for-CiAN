 ...
 * RCS: $Id: StreetMobilityInfo.java,v 1.1.1.1 2006/02/20 23:26:42 drchoffnes
 * Exp $
...
public class StreetMobilityInfo implements MobilityInfo
{
    ...
    public static float            acceleration                  = 2.23f;                    // 5
                                                                                              // mph
                                                                                              // per
                                                                                              // second
    /** average deceleration rate */
    public static float            deceleration                  = 5 * 2.23f;                // 25
                                                                                              // mph
                                                                                              // per
                                                                                              // second,
                                                                                              // to
