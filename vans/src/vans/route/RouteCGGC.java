...
public class RouteCGGC implements RouteInterface.Cggc
{
    ...
    public void peek(NetMessage msg, byte interfaceId, MacAddress lastHop) {
        ...
        if (ipOpt != null)
            updateLmp(interfaceId, ((NetMessage.IpOptionHopLoc) ipOpt).getLoc(), lastHop);
    ...
    public void timeout() {
        ...
        net.send(msg, NetAddress.ANY, Constants.NET_PROTOCOL_CGGC, Constants.NET_PRIORITY_NORMAL, (byte) 0);
